...
export async function POST(req: NextRequest) {
  ...
  const item = await prisma.testimonial.create({ data: { ...createFields, published: published ?? undefined } });
...
export async function PUT(req: NextRequest) {
  ...
  const item = await prisma.testimonial.update({ where: { id }, data: { ...updateFields, published: pub ?? undefined } });
